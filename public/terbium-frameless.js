...
(function (window) {
	...
	const TerbiumFrameless = {
		...
		startDragInBounds: function (e, bounds) {
			...
			if ((bounds.top === undefined || relativeY >= bounds.top) && (bounds.bottom === undefined || relativeY <= bounds.bottom) && (bounds.left === undefined || relativeX >= bounds.left) && (bounds.right === undefined || relativeX <= bounds.right)) {
				this.startDrag(e);
				return true;
			}
			return false;
